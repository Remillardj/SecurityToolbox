...
- Format output in clean Markdown"""
    ...
    def _build_prompt(
        ...
        instructions = [
            ...
            f"Generate a professional incident report based on the above investigation data.",
            f"",
...
<footer style="margin-top: 3rem; padding-top: 1rem; border-top: 1px solid #ddd; color: #666; font-size: 0.9rem;">
    Generated by BSOT Report Module | {datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S UTC')}
</footer>
</body>
</html>"""
...
def generate_report_without_llm(case: Case) -> str:
    ...
    # Footer
    sections.append("---")
    sections.append(f"*Report generated by BSOT on {datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S UTC')}*")
